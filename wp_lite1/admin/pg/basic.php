<fieldset>
    ...
    <?php $field->select('theme_settings[theme_styles]', 'Use theme styles?', ($options['theme_styles']?$options['theme_styles']:'yes'), $req, ['yes','no'], $desc, $css_class)?>
    <?php $field->checkbox('theme_settings[custom_header]', 'Use custom header?', $options['custom_header'], $req, 'yes', $desc, $css_class)?>
    <?php $field->checkbox('theme_settings[custom_footer]', 'Use custom footer?', $options['custom_footer'], $req, 'yes', $desc, $css_class)?>
</fieldset>