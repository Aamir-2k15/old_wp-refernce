...
border-radius:<?=$options['default_btn_primary_borderradius_top']?> <?=$options['default_btn_primary_borderradius_right']?> <?=$options['default_btn_primary_borderradius_bottom']?> <?=$options['default_btn_primary_borderradius_left']?>;
...
border-radius:<?=$options['default_btn_secondary_borderradius_top']?> <?=$options['default_btn_secondary_borderradius_right']?> <?=$options['default_btn_secondary_borderradius_bottom']?> <?=$options['default_btn_secondary_borderradius_left']?>;
...
border-radius:<?=$options['default_btn_tertiary_borderradius_top']?> <?=$options['default_btn_tertiary_borderradius_right']?> <?=$options['default_btn_tertiary_borderradius_bottom']?> <?=$options['default_btn_tertiary_borderradius_left']?>;
