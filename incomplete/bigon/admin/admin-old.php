...
<?php    }
  ...
  <div class="form-group row">
    ...
    <div class="col-md-8">
      ...
      <br />
      <div class="small-note">Enter an URL or upload an image for the <?=$name;?>.</div>
      </label>
    </div>
    <div class="col-md-2">
      <?php if($options[$name]):?>
      <div class="preview"><img src="<?php echo $options[$name]; ?>"/></div>
      <div class="preview"><span class="small-note"><?=$name;?> Preview</span></div>
      <?php endif;?>
    </div>
  </div>
<script>
