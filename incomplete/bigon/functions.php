...
function add_theme_scripts() { 
  wp_enqueue_style( 'meanmenu', get_template_directory_uri() . '/css/meanmenu.min.css', array(), '1.1', 'all');
  wp_enqueue_style( 'animate', get_template_directory_uri() . '/css/animate.css', array(), '1.1', 'all');
  wp_enqueue_style( 'nivo-slider', get_template_directory_uri() . '/css/nivo-slider.css', array(), '1.1', 'all');
  ...
  wp_enqueue_style( 'jquery-ui', get_template_directory_uri() . '/css/jquery-ui.min.css', array(), '1.1', 'all');
  ...
  wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/vendor/modernizr-2.8.3.min.js', array ( 'jquery' ), 2.8, true);
  wp_enqueue_script( 'meanmenu', get_template_directory_uri() . '/js/jquery.meanmenu.min.js', array ( 'jquery' ), 1.1, true);
  wp_enqueue_script( 'scrollUp', get_template_directory_uri() . '/js/jquery.scrollUp.js', array ( 'jquery' ), 1.1, true);
  ...
  wp_enqueue_script( 'jquery-countdown', get_template_directory_uri() . '/js/jquery.countdown.min.js', array ( 'jquery' ), 1.1, true);
  wp_enqueue_script( 'jquery_nivo-slider', get_template_directory_uri() . '/js/jquery.nivo.slider.js', array ( 'jquery' ), 1.1, true);
...
///////////////////////////
//include('inc/contact-form-7/wp-contact-form-7.php');
include('inc/elementor/elementor.php');?>