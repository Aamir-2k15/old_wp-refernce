...
define( 'ELEMENTOR_PLUGIN_BASE',  __FILE__ );

define( 'ELEMENTOR_PATH', plugin_dir_path( ELEMENTOR__FILE__ ) );

/*if ( defined( 'ELEMENTOR_TESTS' ) && ELEMENTOR_TESTS ) {
	define( 'ELEMENTOR_URL', get_template_directory().'/inc/elementor/');
} else {
	define( 'ELEMENTOR_URL', get_template_directory().'/inc/elementor/' );
}*/

define( 'ELEMENTOR_MODULES_PATH', get_template_directory() . 'modules' );
define( 'ELEMENTOR_ASSETS_PATH', get_template_directory() . '/inc/elementor/assets/' );
define( 'ELEMENTOR_ASSETS_URL', get_bloginfo('url').'/wp-content/themes/bigon/inc/elementor/assets/' );

add_action( 'plugins_loaded', 'elementor_load_plugin_textdomain' );

#echo '<hr/>'.get_bloginfo('url'); exit;
