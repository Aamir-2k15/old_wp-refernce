...
<?php wp_head(); ?>
<style>#wrap{max-width: 100%;}footer ul {list-style: none;padding-left: 0;}.full-width,.full_width{width: 100%;max-width: 100%;position: relative;}
.wpcf7-form.init p label { min-width: 85%;}
.wpcf7-form.init p label span, .wpcf7-form.init p label span *{ min-width: 100%;width: 100%;}
.wpcf7-form.init p label span *{width: 100%;padding:5px 8px;}
</style>
<!--dynamic!--><?php if($options['theme_styles']=="yes"){?><link rel='stylesheet' type='text/css' href="<?=get_template_directory_uri();?>/inc/dynamic_styles.php"/><?php } ?>
</head>
